...
## English matrix figure

The locked Old-ESM2 (M0) through M6 matrix is rendered as an all-English annotated
heatmap and companion tables under:

`benchmark/reports/summary/esmc_matrix_20260712/english_matrix/`

- `esm2_m1_m6_matrix_english.pdf`: publication-quality vector figure.
- `esm2_m1_m6_matrix_english.png`: 300-DPI raster preview.
- `esm2_m1_m6_matrix_english.{md,tsv,tex}`: Markdown, machine-readable, and LaTeX tables.
- `esm2_m1_m6_matrix_english.sources.json`: source paths, hashes, and exact plotted rows.

The figure is regenerated by `scripts/analysis/plot_esm2_m1_m6_matrix.py`. It contains
the historical locked M0-M6 values only and deliberately excludes M7 and the newer
seed-averaged M6 result.
