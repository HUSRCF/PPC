...
def _default_args() -> SimpleNamespace:
    return SimpleNamespace(
        ...
        prottrans_embedding_root=None,
        require_sequence_features=False,
        require_prottrans_embeddings=False,
        batching="random",
        max_batch_tokens=0,
...
def main() -> int:
    ...
    loader = _build_loader(
        ...
        cfg_args.prottrans_embedding_root,
        cfg_args.require_sequence_features,
        cfg_args.require_prottrans_embeddings,
        args.batch_size,
        args.num_workers,
        False,
        None,
        ...
        cfg_args.seed + 100,
        False,
        batching=cfg_args.batching,
        max_batch_tokens=cfg_args.max_batch_tokens,
        length_bucket_size=cfg_args.length_bucket_size,
        lengths_by_id=None,
        preload=False,
        strict_ids=True,
        require_labels=True,
        strict_label_metadata=True,
        strict_sequence_feature_metadata=cfg_args.strict_sequence_feature_metadata,
